...
import com.example.user.musicsocialclub.SQLite.BDusuarios.*;
...
public class OperacionesBaseDatos {
    ...
    public boolean actualizarUsuario(UsuarioClass cliente) {
        SQLiteDatabase db = baseDatos.getWritableDatabase();
        ...
        final String[] whereArgs = {cliente.getIdGenerate()};
